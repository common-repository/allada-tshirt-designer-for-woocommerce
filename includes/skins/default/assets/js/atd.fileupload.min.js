  ...
  (m.support.fileInput = !(
    ...
    m.widget("blueimp.fileupload", {
        ...
        if (e.lengthComputable) {
          ...
          (t._time = r),
            ...
            (t._progress.bitrate = t.bitrate =
              t._bitrateTimer.getBitrate(r, i, t.bitrateInterval)),
            this._trigger(
              "progress",
      ...
      _deinitProgressListener: function (e) {
        ...
        t.upload && m(t.upload).off("progress");
      },
            ...
            ? (((s =
                1 < this.options.limitConcurrentUploads
                  ? ((o = m.Deferred()),
                    this._slots.push(o),
                    o[a._promisePipe](i))
                  : ((this._sequence = this._sequence[a._promisePipe](i, i)),
                    this._sequence)).abort = function () {
                return (
                  (n = [void 0, "abort", "abort"]),
                  r ? r.abort() : (o && o.rejectWith(l.context, n), i())
                );
              }),
      ...
      _handleFileTreeEntry: function (i, r) {
        function n(e) {
          e && !e.entry && (e.entry = i), s.resolve([e]);
        }
        var e,
          o = this,
          s = m.Deferred(),
          ...
          l = function () {
            e.readEntries(function (e) {
              ...
              e.length
                ...
                : ((t = a),
                  o
                    ._handleFileTreeEntries(t, r + i.name + "/")
                    .done(function (e) {
                      s.resolve(e);
                    })
                    .fail(n));
        ...
        return (
          ...
          i.isFile
            ? i._file
              ? ((i._file.relativePath = r), s.resolve(i._file))
              : i.file(function (e) {
                  (e.relativePath = r), s.resolve(e);
                }, n)
            : i.isDirectory
            ? ((e = i.createReader()), l())
            : s.resolve([]),
      ...
      _getSingleFileInputFiles: function (e) {
        var t,
          i,
          r = (e = m(e)).prop("webkitEntries") || e.prop("entries");
      ...
      _initDataAttributes: function () {
        ...
        m.each(this.element[0].attributes, function (e, t) {
          ...
          /^data-/.test(r) &&
            ((r = r.slice(5).replace(/-[a-z]/g, function (e) {
              return e.charAt(1).toUpperCase();
            })),
            (i = s[r]),
            n._isRegExpOption(r, i) && (i = n._getRegExp(i)),
            (o[r] = i));
        });
      },
      _create: function () {
