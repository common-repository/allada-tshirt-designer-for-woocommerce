var atd_EDITOR = (function ($, atd_editor) {
  ...
  $(document).ready(function () {
    ...
    $(
      ".atd-textarea-field textarea, .atd-editing-text, .atd-team-wrap, .atd-filter-container, .atd-clippart-group-container, .atd-preview-clippart-group, .atd-preview-upolad-container, .atd-team-tools-wrap, .atd-my-design-container, .atd-font-drop-down, .atd-team-list-section, .atd-totals-team-variations, .atd-preview-box-add-cart-inner, .atd-add-cart-content-details, .atd-preview-box-quantity-inner, .atd-ui-qty-details:last-child, .wb-team-help-duplicates"
    ).perfectScrollbar({
      suppressScrollX: true,
    });

    function doPerfectScrollbarInMobile($this) {
      if ($this === undefined) {
        $this = $(window);
      }

      if ($this.innerWidth() <= 394) {
        $(".atd-navigation-canvas").perfectScrollbar({
          suppressScrollX: true,
        });
      } else {
        $(".atd-navigation-canvas").perfectScrollbar("destroy");
      }
    }

    doPerfectScrollbarInMobile();

    $(window).resize(function (e) {
      doPerfectScrollbarInMobile($(this));
    });

    $(".atd-team-list-container").perfectScrollbar({
    ...
    $(".atd-menu .atd-tab-item").click(function (e) {
      ...
      $(this)
        .closest(".atd-tab-tools .atd-menu")
        .find("li.active")
        .removeClass("active");
      ...
      switch (targetLi) {
        case "text":
          $(".atd-tab-tools-content[data-title='text']").css("left", "0");
          $(".atd-tab-tools-content[data-title='clippart']").css(
            "left",
            "150%"
          );
          $(".atd-tab-tools-content[data-title='upload']").css("left", "150%");
          $(".atd-tab-tools-content[data-title='team']").css("left", "150%");
          $(".atd-tab-tools-content[data-title='design']").css("left", "150%");
          $(".atd-tab-tools-content[data-title='cart']").css("left", "150%");
          $(".atd-canvas-box").css("left", "-150%");
          break;
        case "clippart":
          $(".atd-tab-tools-content[data-title='clippart']").css("left", "0");
          $(".atd-tab-tools-content[data-title='text']").css("left", "150%");
          $(".atd-tab-tools-content[data-title='upload']").css("left", "150%");
          $(".atd-tab-tools-content[data-title='team']").css("left", "150%");
          $(".atd-tab-tools-content[data-title='design']").css("left", "150%");
          $(".atd-tab-tools-content[data-title='cart']").css("left", "150%");
          ...
          break;
        case "upload":
          $(".atd-tab-tools-content[data-title='upload']").css("left", "0");
          $(".atd-tab-tools-content[data-title='text']").css("left", "150%");
          $(".atd-tab-tools-content[data-title='clippart']").css(
            "left",
            "150%"
          ...
          break;
        case "team":
          $(".atd-tab-tools-content[data-title='team']").css("left", "0");
          $(".atd-tab-tools-content[data-title='text']").css("left", "150%");
          $(".atd-tab-tools-content[data-title='clippart']").css(
            "left",
            "150%"
          ...
          break;
        case "design":
          $(".atd-tab-tools-content[data-title='design']").css("left", "0");
          $(".atd-tab-tools-content[data-title='text']").css("left", "150%");
          $(".atd-tab-tools-content[data-title='clippart']").css(
            "left",
            "150%"
          ...
          break;
        case "cart":
          $(".atd-tab-tools-content[data-title='cart']").css("left", "0");
          $(".atd-tab-tools-content[data-title='text']").css("left", "150%");
          $(".atd-tab-tools-content[data-title='clippart']").css(
            "left",
            "150%"
    ...
    $(".atd-icon-conf").click(function () {
      $(".atd-tab-item").removeClass("active");

      $(".atd-canvas-box").css("left", "0%");
      $(".atd-tab-tools-content[data-title='text']").css("left", "150%");
      $(".atd-tab-tools-content[data-title='clippart']").css("left", "150%");
      $(".atd-tab-tools-content[data-title='upload']").css("left", "150%");
      $(".atd-tab-tools-content[data-title='team']").css("left", "150%");
      $(".atd-tab-tools-content[data-title='design']").css("left", "150%");
      $(".atd-tab-tools-content[data-title='cart']").css("left", "150%");
    ...
    /* Begin Carousel Tag Script */

    $(".atd-menu").owlCarousel({
      margin: 0,
    ...
    $(document).on("click", function (e) {
      ...
      // if (
      //   $this.closest(".atd-tab-tools-content[data-title='clippart']")
      //     .length === 0
      // ) {
      //   $(".atd-clippart-inner").addClass("atd-active");
      ...
      // if (
      //   $this.closest(".atd-tab-tools-content[data-title='upload']").length ===
      //   0
      // ) {
    ...
    $(".atd-range-slider input").on("input", function (e) {
      ...
      // var valueWithPercent = 0;

      // if (value < 5) {
      //   valueWithPercent = parseInt(value + 0) + "%";
      // } else {
      //   valueWithPercent = parseInt(value + 0) - parseInt(15) + "%";
      // }

      // $(this)
      //   .closest(".atd-range-slider")
      //   .find(".atd-thumb")
      //   .css("left", valueWithPercent);

      // $(this)
      //   .closest(".atd-range-slider")
      //   .find(".atd-progress-bar")
      //   .css("width", valueWithPercent);
      ...
      // $(this)
      //   .closest(".atd-range-slider-inner")
      //   .find(".atd-slider-value span")
      //   .text(value);
    ...
    //   $(this)
    //     .closest(".atd-font-container")
    //     .find(".atd-font-label")
    //     .text($(this).find(".atd-font-name").text());
    // });
    ...
    $(".atd-my-design-tab-item").click(function () {
      ...
      if (targetLi == "past-order") {
        ...
        $(".atd-my-design-saved").css("left", "-350%");
      } else {
        $(".atd-underline-design").css("left", "0");

        $(".atd-my-design-past").css("left", "-350%");
    ...
    // function reCalculatePrice($target) {
    //   var $targetPrice = $target
    //     .closest(".atd-cart-item")
    //     .find(".atd-cart-price");

    //   var oldPrice = $targetPrice.data("price");

    //   var userEnter = parseInt($target.val());

    //   $target.attr("data-old_qty", userEnter);

    //   var totalPrice = userEnter * oldPrice;

    //   $targetPrice.text(parseInt(totalPrice));
    // }

    // var atdIncOrDec = function ($btn, action) {
    //   // Increment or decrement depending on user action on plus or minus buttons

    //   var newPrice = 0;

    //   var $parentItem = $btn.closest(".atd-cart-item");

    //   var $targetPrice = $parentItem.find(".atd-cart-price");

    //   var $targetQty = $parentItem.find(".atd-cart-qty");

    //   var oldPrice = $targetPrice.data("price");

    //   var qty = parseInt($targetQty.val());

    //   var minQty = parseInt($(".atd-cart-qty").attr("min"));

    //   var maxQty = parseInt($(".atd-cart-qty").attr("max"));

    //   if (action === "increase") {
    //     qty++;

    //     $btn
    //       .closest(".atd-icon-btn")
    //       .find(".atd-icon-btn-item")
    //       .removeClass("atd-disable");

    //     $targetQty.val(qty);

    //     $targetQty.attr("data-old_qty", qty);

    //     newPrice = qty * parseInt(oldPrice);
    ...
    // $(".atd-icon-minus").click(function (e) {
    //   var $btn = atdIncOrDec($(this));
    // });

    // $(".atd-cart-qty").keyup(function (e) {
    //   var oldPrice =
    //     $(this).data("old_qty") === undefined ? 1 : $(this).data("old_qty");

    //   var minQty = parseInt($(".atd-cart-qty").attr("min"));

    //   var maxQty = parseInt($(".atd-cart-qty").attr("max"));

    //   if (parseInt(e.target.value) > maxQty) {
    //     $(this).val(oldPrice);
    //   }

    //   if (parseInt(e.target.value) < minQty) {
    //     $(this).val(oldPrice);
    //   }
    ...
    /** Begin Loader for ATD Script */

    // setTimeout(() => {

    //     $(".atd-loader").css("opacity", "0");

    //     setTimeout(() => {

    //         $(".atd-loader").css("display", "none");

    //     }, 5000000);

    // }, 15000000);

    /** End Loader for ATD Script */
  });
