...
class ATD_Skin_Default_Mobile {
	...
	public function display() {
		...
		<div class="atd-container atd-mobile <?php echo ( $cnd_is_valid ) ? 'isHidden' : ''; ?> " >
		...
		<!-- Section Bottom Add To Cart Begin -->
				...
				if ( 'variable' === $product->get_type() ) {
					...
					if ( ! $set_attr_name ) {
						...
						?>
							 <div class="atd-container-add-cart">
							 <?php

								echo wp_kses( $this->get_bottom_add_to_cart_content(), $allowed_tags );
								?>
								<span atd-related-product-id="<?php echo esc_attr( $product->get_id() ); ?>" class="isHidden"></span>
								<?php
	...
	private function get_first_section_content() {
		...
		<div class="atd-section atd-tab-tools">
			...
			<div class="atd-menu owl-carousel">

				<li class="atd-tab-item" data-title="text">

					<div class="atd-icon"><i class="icon-261"></i></div>

					<span><?php echo esc_html__( 'Add Text', 'allada-tshirt-designer-for-woocommerce' ); ?></span>
				...
				<li class="atd-tab-item" data-title="clippart">
					...
					<span><?php echo esc_html__( 'Add clippart', 'allada-tshirt-designer-for-woocommerce' ); ?></span>
				...
				<li class="atd-tab-item" data-title="upload">
					...
					<span><?php echo esc_html__( 'Upload art', 'allada-tshirt-designer-for-woocommerce' ); ?></span>
				...
				if ( 'variable' === $product->get_type() && 'yes' === $get_product_team_data['enable-team'] ) {
					...
					<li class="atd-tab-item" data-title="team">
						...
						<span><?php echo esc_html__( 'Team', 'allada-tshirt-designer-for-woocommerce' ); ?></span>
				...
				<li class="atd-tab-item" data-title="design">
					...
					<span><?php echo esc_html__( 'My designs', 'allada-tshirt-designer-for-woocommerce' ); ?></span>
				...
				if ( 'simple' === $product->get_type() ) {
					?>
						<li class="atd-tab-item  " data-title="cart"  >
							...
							<span><?php echo esc_html__( 'Cart', 'allada-tshirt-designer-for-woocommerce' ); ?></span>
				...
				<div class="atd-add-cart-details">
					...
					<div class="atd--add-cart-info">
						...
						<p class="atd-cart-p">
							...
							<!-- <span class="atd-cart-link"><?php echo esc_html__( 'Change Product', 'allada-tshirt-designer-for-woocommerce' ); ?></span> -->
						...
						<p class="atd-cart-p">
							...
							<!--<span class="atd-cart-link"><?php echo esc_html__( 'Change Color', 'allada-tshirt-designer-for-woocommerce' ); ?></span> -->
	...
	private function get_preview_modal_add_product() {
		...
		<div class="atd-ui-qty-details">
			...
			<div class="atd-ui-qty-details-content">
				...
				<!-- <div class="atd-badge"><span class="atd-ui-qty-price">$20</span></div> -->
	...
	private function get_toolbar() {
		...
		<div class="atd-canvas-item-top">
			...
			<div class="atd-icon-tooltip" id="atd-icon-tooltip-alignment">
				...
				<div class="atd-tooltip atd-tooltip-top"><?php echo esc_html__( 'Alignments', 'allada-tshirt-designer-for-woocommerce' ); ?></div>
			...
			<div class="atd-icon-tooltip">
				...
				<div class="atd-tooltip atd-tooltip-top"><?php echo esc_html__( 'Duplicate', 'allada-tshirt-designer-for-woocommerce' ); ?></div>
		...
		<div class="atd-canvas-item-bottom">
			...
			<div class="atd-icon-tooltip">
				...
				<div class="atd-tooltip atd-tooltip-top"><?php echo esc_html__( 'Delete', 'allada-tshirt-designer-for-woocommerce' ); ?></div>
			...
			<div class="atd-icon-tooltip">
				...
				<div class="atd-tooltip atd-tooltip-top"><?php echo esc_html__( 'Clear&nbsp;all', 'allada-tshirt-designer-for-woocommerce' ); ?></div>
		...
		<div class="atd-context-menu-alignment">
			...
			<div class="atd-row-context">
				...
				<div class="atd-icon-tooltip">
					...
					<div class="atd-tooltip atd-tooltip-bottom"><?php echo esc_html__( 'Send&nbsp;to&nbsp;back', 'allada-tshirt-designer-for-woocommerce' ); ?></div>
				...
				<div class="atd-icon-tooltip">
					...
					<div class="atd-tooltip atd-tooltip-bottom"><?php echo esc_html__( 'Bring&nbsp;to&nbsp;front', 'allada-tshirt-designer-for-woocommerce' ); ?></div>
			...
			<div class="atd-row-context">
				...
				<div class="atd-icon-tooltip">
					...
					<div class="atd-tooltip atd-tooltip-bottom"><?php echo esc_html__( 'Flip&nbsp;H', 'allada-tshirt-designer-for-woocommerce' ); ?></div>
				...
				<div class="atd-icon-tooltip">
					...
					<div class="atd-tooltip atd-tooltip-bottom"><?php echo esc_html__( 'Flip&nbsp;V', 'allada-tshirt-designer-for-woocommerce' ); ?></div>
			...
			<div class="atd-row-context">
				...
				<div class="atd-icon-tooltip">
					...
					<div class="atd-tooltip atd-tooltip-bottom"><?php echo esc_html__( 'Center&nbsp;H', 'allada-tshirt-designer-for-woocommerce' ); ?></div>
				...
				<div class="atd-icon-tooltip">
					...
					<div class="atd-tooltip atd-tooltip-bottom"><?php echo esc_html__( 'Center&nbsp;V', 'allada-tshirt-designer-for-woocommerce' ); ?></div>
	...
	private function get_output_toolbar() {
		...
		<div class="atd-canvas-item-top">
			...
			<div class="atd-icon-tooltip">
				...
				<div class="atd-tooltip atd-tooltip-bottom"><?php echo esc_html__( 'Undo', 'allada-tshirt-designer-for-woocommerce' ); ?></div>
			...
			<div class="atd-icon-tooltip">
				...
				<div class="atd-tooltip atd-tooltip-bottom"><?php echo esc_html__( 'Redo', 'allada-tshirt-designer-for-woocommerce' ); ?></div>
		...
		<div class="atd-canvas-item-bottom">
			...
			<div class="atd-icon-tooltip atd-prev-des" id="preview-btn">
				...
				<div class="atd-tooltip atd-tooltip-bottom"><?php echo esc_html__( 'Preview', 'allada-tshirt-designer-for-woocommerce' ); ?></div>
			...
			<div class="atd-icon-tooltip">
				...
				<div class="atd-tooltip atd-tooltip-bottom"><?php echo esc_html__( 'Download', 'allada-tshirt-designer-for-woocommerce' ); ?></div>
			...
			<div class="atd-icon-tooltip atd-save-des">
				...
				<div class="atd-tooltip atd-tooltip-bottom"><?php echo esc_html__( 'Save', 'allada-tshirt-designer-for-woocommerce' ); ?></div>
		...
		<!-- <div class="omodal fade o-modal atd-modal" id="atd_save_design" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="omodal-dialog">
				<div class="omodal-content">
					<div class="omodal-header">
						<button type="button" class="close ti-close" data-dismiss="omodal" aria-hidden="true"></button>
						<h4 class="omodal-title" id="myModalLabel">Save design</h4>
					</div>
					<div class="omodal-body txt-center">
		<?php
		if ( isset( $design_index ) && $design_index >= 0 ) {
			?>
				<p>You try to make a backup from another save, Would you like to overwrite the previous backup by this one?</p>
				<button id="save-btn" class="atd-btn-effect" data-index="<?php echo esc_attr( $design_index ); ?>" data-action="replace">Replace</button>
				<button id="save-btn" class="atd-btn-effect" data-index="<?php echo esc_attr( $design_index ); ?>" data-action="new-save">New Save</button>
			<?php
		} else {
			?>
				<input id="design-name" type="text" class="text-element-border text-container " name="design-name" placeholder="Design name" required>
				<button id="save-btn" class="atd-btn-effect" data-index="<?php echo esc_attr( $design_index ); ?>">Save</button>
			<?php
		}
		?>
					</div>
	...
	private function get_text_tools() {
		...
		<div class="atd-add-text atd-active">
			...
			<div class="atd-icon-conf"><i class="fas fa-arrow-left"></i></div>
		...
		echo wp_kses( $this->get_editing_text_tools(), $allowed_tags );
			...
			<div class="atd-font-drop-down">
				...
				if ( isset( $this->atd_metas['global-fonts'] ) && 'no' === $this->atd_metas['global-fonts']['use-global-fonts'] && isset( $this->atd_metas['global-fonts']['selected-fonts'] ) && ! empty( $this->atd_metas['global-fonts']['selected-fonts'] ) ) {
					...
					foreach ( $fonts as $font ) {
						$font_label = wp_json_decode( $font )[0];
						?>
						<li class="atd-font-drop-down-item" style="font-family: <?php echo esc_html( $font_label ); ?>">
	 ...
	 * Get uploads tools.
	 *
	 * @param array $uploads_options Upload options.
	 * @return string $output The output.
	 */
	...
	/**
	 * Check icon image part.
	 *
	 * @return bool $is_icon_image Return true if icon is part image.
	 */
	private function check_icon_image_part() {
		$root_variation_id   = $this->editor->atd_product->variation_id;
		$root_product_id     = $this->editor->atd_product->root_product_id;
							...
							foreach ( $cliparts as $clipart ) {
								...
								<div class="atd-preview-clippart-item" data-title="<?php echo esc_attr( $name ); ?>" data-groupid="<?php echo esc_attr( $cliparts_group->ID ); ?>" data-img-name="<?php echo esc_attr( $name ); ?>" data-price="<?php echo esc_attr( $price ); ?>" data-original="<?php echo esc_attr( $attachment_url ); ?>" data-url="<?php echo esc_attr( $attachment_url ); ?>" data-src="<?php echo esc_attr( $attachment_url ); ?>">
									...
									<div class="atd-preview-clippart-item-details">
										...
										<span class="atd-clippart-name"><?php echo esc_html( $name ); ?></span>

										<span class="atd-clippart-price">$&nbsp;<?php echo esc_html( $price ); ?></span>
				...
				<select class="atd-select atd-team-name-side" name="atd-team-name-side">
					...
					if ( isset( $parts ) && ! empty( $parts ) ) {
						foreach ( $parts as $part_key => $part_data ) {
							if ( 'yes' === $part_data['enable'] ) {
								?>
								<option value="<?php echo esc_attr( $part_key ); ?>" class="atd-option"><?php echo esc_attr( $part_data['name'] ); ?></option>
								?>
								<?php
							}
						}
	...
	private function get_preview_modal_team() {
		/* die(var_dump(atd_get_related_custom_product_details($this->editor->atd_product->root_product_id))); */
		$sizes = array(
			''  => '',
			'l' => 'L',
			'm' => 'M',
										...
										<?php if ( isset( $sizes ) && ! empty( $sizes ) ) { ?>
											...
											<select class="atd-select atd-team-sizes-list" name="atd-team-sizes-list[]">
												...
												<?php foreach ( $sizes as $key => $size ) { ?>
													...
													<option value="<?php echo esc_attr( $key ); ?>" class="atd-option"><?php echo esc_html( $size ); ?></option>
								...
								foreach ( $datas as $data_key => $data ) {
									if ( ! empty( $data ) ) {
										...
										<div class="atd-preview-saved-item">
											...
											<header><?php echo esc_html_( $data_key, 'allada-tshirt-designer-for-woocommerce' ); ?></header>
	...
	private function get_cart_tools() {
		...
		$add_to_cart_label = __( 'ADD TO CART', 'allada-tshirt-designer-for-woocommerce' );

		if ( isset( $wp_query->query_vars['edit'] ) ) {

			$add_to_cart_label = __( 'UPDATE CART ITEM', 'allada-tshirt-designer-for-woocommerce' );
		}
		...
		<div class="atd-tab-tools-content" data-title="cart">
			...
			if ( isset( $this->atd_meta['related-quantities'] ) && ! empty( $this->atd_meta['related-quantities'] ) && $product->get_type() == 'variation' ) {
						...
						if ( $combine ) {
							...
							<div class="atd-qty-container" data-id="<?php echo esc_attr( $variation_to_load ); ?>" <?php echo esc_attr( $quantity_display ); ?>>
								...
								<div class="atd-cart-item">
									...
									<label><?php echo esc_html( $attribute_str ); ?></label>
				...
				$price_html          = ' <span class="total_order atd-cart-price">' . wc_price( $price * $purchase_properties['min_to_purchase'] ) . '</span>';
				$custom_quantity     = filter_input( INPUT_GET, 'custom_qty' );

				if ( ! isset( $custom_quantity ) || empty( $custom_quantity ) ) {
		...
		if ( is_user_logged_in() ) {
			...
			<div class="atd-my-design-container">
				...
				<div class="atd-my-design-item atd-my-design-saved" data-title="saved-design">
					...
					<?php echo wp_kses( $this->get_user_design_output_block( $user_designs ), $allowed_tags ); ?>
				...
				foreach ( $user_designs as $s_index => $user_design ) {
					if ( ! empty( $user_design ) ) {
						...
						<li class="atd-my-design-saved-item" data-name="<?php echo esc_attr( $design_name ); ?>"> 
							<div class="atd_order_item" data-variation-id="<?php echo esc_attr( $variation_id ); ?>" data-save-time="<?php echo esc_attr( $save_time ); ?>" data-design-name="<?php echo esc_attr( $design_name ); ?>" data-order-item-id="<?php echo esc_attr( $order_item_id ); ?>"><div><?php echo esc_html( $design_name ) . ' - ' . esc_html( $save_time ); ?></div></div>
						</li>                                
						<?php
					}
				}
		...
		<div class="atd-preview-box-save">
			...
			if ( isset( $design_index ) && $design_index >= 0 ) {
				...
				<div class="atd-btns-save">
					...
					<button class="atd-btn-save atd-btn-save-save" data-index="<?php echo esc_attr( $design_index ); ?>" id="save-btn"><?php echo esc_html_e( 'Save', 'allada-tshirt-designer-for-woocommerce' ); ?></button>
	...
	private function register_styles() {
		wp_enqueue_style( 'atd-allada', ATD_URL . 'includes/skins/default/assets/css/atd-allada-mobile.css', array(), ATD_VERSION, 'all' );
	...
	private function register_scripts() {
		wp_enqueue_script( 'atd-allada', ATD_URL . 'includes/skins/default/assets/js/atd-allada-mobile.js', array( 'jquery' ), ATD_VERSION, false );
